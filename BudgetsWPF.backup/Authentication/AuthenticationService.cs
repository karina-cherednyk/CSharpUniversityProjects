...
namespace BudgetsWPF.Authentication
{
    ...
    {
        private FileDataStorage<DBUser> _authStorage = new FileDataStorage<DBUser>();
       // private FileDataStorage<User> _userDataStorage = new FileDataStorage<User>();

        public async Task<bool> RegisterUserAsync(DBUser regUser)
        {
            //Thread.Sleep(2000);
            var users = await _authStorage.GetAllAsync();
            ...
            await _authStorage.AddOrUpdateAsync(regUser);
            return true;
        }
